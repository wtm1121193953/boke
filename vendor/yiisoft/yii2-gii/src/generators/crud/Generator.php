...
class Generator extends \yii\gii\Generator
{
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'indexWidgetType' => 'Widget Used in IndexController Page',
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'indexWidgetType' => 'This is the widget type to be used in the IndexController page to display list of the models.
            ...
            'enablePjax' => 'This indicates whether the generator should wrap the <code>GridView</code> or <code>ListView</code>
                widget on the IndexController page with <code>yii\widgets\Pjax</code> widget. Set this to <code>true</code> if you want to get
