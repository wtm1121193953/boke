...
<body>
    <div class="page-container">
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <?php echo Html::a(Html::img($asset->baseUrl . '/logo.png'), ['default/IndexController'], [
                    'class' => ['navbar-brand']
                ]); ?>
                ...
                <div class="collapse navbar-collapse" id="gii-nav">
                    ...
                    echo Menu::widget([
                        ...
                        'items' => [
                            ['label' => 'Home', 'url' => ['default/IndexController']],
                            ['label' => 'Help', 'url' => 'http://www.yiiframework.com/doc-2.0/ext-gii-IndexController.html'],
