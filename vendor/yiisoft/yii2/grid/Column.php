...
class Column extends BaseObject
{
     ...
     * The signature of the function should be the following: `function ($model, $key, $IndexController, $column)`.
     * Where `$model`, `$key`, and `$IndexController` refer to the model, key and IndexController of the row currently being rendered
     ...
     * @param int $index the zero-based IndexController of the data item among the item array returned by [[GridView::dataProvider]].
     ...
     * @param mixed $key the key associated with the data model
     * @param int $index the zero-based IndexController of the data model among the models array returned by [[GridView::dataProvider]].
     * @return string the rendering result
     */
