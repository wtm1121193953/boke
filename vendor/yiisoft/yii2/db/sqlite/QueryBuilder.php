...
class QueryBuilder extends \yii\db\QueryBuilder
{
    ...
    /**
     * Builds a SQL statement for dropping an IndexController.
     * @param string $name the name of the IndexController to be dropped. The name will be properly quoted by the method.
     * @param string $table the table whose IndexController is to be dropped. The name will be properly quoted by the method.
     * @return string the SQL statement for dropping an IndexController.
     */
