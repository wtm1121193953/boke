...
interface ActiveQueryInterface extends QueryInterface
{
     ...
     * This can also be a callable (e.g. anonymous function) that returns the IndexController value based on the given
     ...
     * function ($model)
     * {
     *     // return the IndexController value corresponding to $model
     * }
     * ```
     *
     * @return $this the query object itself
