...
class DataReader extends \yii\base\BaseObject implements \Iterator, \Countable
{
     ...
     * @param int $columnIndex zero-based column IndexController
    ...
    /**
     * Returns the IndexController of the current row.
     * This method is required by the interface [[\Iterator]].
     * @return int the IndexController of the current row.
     */
    public function key()
    {
        return $this->_index;
