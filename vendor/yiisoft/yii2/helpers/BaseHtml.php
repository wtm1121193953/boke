...
class BaseHtml
{
     ...
     *
     *   ```php
     *   function ($IndexController, $label, $name, $checked, $value)
     *   ```
     *
     *   where $IndexController is the zero-based IndexController of the checkbox in the whole list; $label
     ...
     *   ```
     *
     *   where $IndexController is the zero-based IndexController of the radio button in the whole list; $label
     ...
     *
     *   ```php
     *   function ($item, $IndexController)
     *   ```
     *
     *   where $IndexController is the array key corresponding to `$item` in `$items`. The callback should return
