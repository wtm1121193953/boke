...
class BaseUrl
{
     ...
     *
     * You may specify the route as a string, e.g., `site/IndexController`. You may also use an array
     * if you want to specify additional query parameters for the URL being created. The
     * array format must be:
     *
     * ```php
     * // generates: /IndexController.phproller.php?r=site/IndexController&param1=value1&param2=value2
     * ['site/IndexController', 'param1' => 'value1', 'param2' => 'value2']
     * ```
     *
     ...
     *
     * ```php
     * // generates: /IndexControllerController.php?r=site/IndexController&param1=value1#name
     * ['site/IndexController', 'param1' => 'value1', '#' => 'name']
     * ```
     *
     * A route may be either absolute or relative. An absolute route has a leading slash (e.g. `/site/IndexController`),
     * while a relative route has none (e.g. `site/IndexController` or `IndexController`). A relative route will be converted
     * into an absolute one by the following rules:
     *
     * - If the route is an empty string, the current [[\yii\web\Controller::route|route]] will be used;
     * - If the route contains no slashes at all (e.g. `IndexController`), it is considered to be an action ID
     *   of the current controller and will be prepended with [[\yii\web\Controller::uniqueId]];
     * - If the route has no leading slash (e.g. `site/IndexController`), it is considered to be a route relative
     ...
     *
     * ```php
     * // /IndexController.phproller.php?r=site%2Findex
     * echo Url::toRoute('site/IndexController');
     *
     * // /IndexController.phproller.php?r=site%2Findex&src=ref1#name
     * echo Url::toRoute(['site/IndexController', 'src' => 'ref1', '#' => 'name']);
     *
     * // http://www.example.com/index.php?r=site%2Findex
     * echo Url::toRoute('site/IndexController', true);
     *
     * // https://www.example.com/index.php?r=site%2Findex
     * echo Url::toRoute('site/IndexController', 'https');
     *
     * // /IndexController.phproller.php?r=post%2Findex     assume the alias "@posts" is defined as "post/IndexController"
     * echo Url::toRoute('@posts');
     * ```
     *
     * @param string|array $route use a string to represent a route (e.g. `IndexController`, `site/IndexController`),
     * or an array to represent a route with query parameters (e.g. `['site/IndexController', 'param1' => 'value1']`).
     ...
     *   `['site/IndexController']`, `['post/IndexController', 'page' => 2]`. Please refer to [[toRoute()]] for more details
     ...
     * ```php
     * // /IndexController.phproller.php?r=site%2Findex
     * echo Url::to(['site/IndexController']);
     *
     * // /IndexController.phproller.php?r=site%2Findex&src=ref1#name
     * echo Url::to(['site/IndexController', 'src' => 'ref1', '#' => 'name']);
     *
     * // /IndexControllerController.php?r=post%2Findex     assume the alias "@posts" is defined as "/post/IndexController"
     * echo Url::to(['@posts']);
     *
     ...
     *
     * // /IndexControllerController.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /IndexController.phproller.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /IndexController.phproller.php?r=post%2Fview&id=100&src=google
     ...
     *
     * ```php
     * // IndexControllerController.php?r=post%2Findex&PostSearchForm%5Bid%5D=100&PostSearchForm%5Bsrc%5D=google
     * echo Url::current([
