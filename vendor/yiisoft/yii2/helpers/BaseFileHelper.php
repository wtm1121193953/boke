...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/IndexControllerController.php` but not `views/controller/IndexController.phproller.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `IndexController.phproller.php` but not `views/start/IndexController.phproller.php`.
