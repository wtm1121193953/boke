...
class HTMLPurifier_ElementDef
{
     ...
     *       contain an array at IndexController 0 that indicates which attribute
    ...
    // forgetting to specify an IndexController (and just using 0.)  While we
    // could check this by checking the IndexController number and complaining,
