...
class SuiteManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGroupEventsAreFired()
    {
        ...
        $this->dispatcher->addListener('test.before.api', $eventListener);
        $this->dispatcher->addListener('test.after', $eventListener);
        $this->dispatcher->addListener('test.after.api', $eventListener);
        ...
        $this->assertContains('test.before.api', $events);
        $this->assertContains('test.after', $events);
        $this->assertContains('test.after.api', $events);
    }
}
